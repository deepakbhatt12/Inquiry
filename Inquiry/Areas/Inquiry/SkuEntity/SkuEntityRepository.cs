              ...
              WITH Q1 AS
                     (SELECT 2 AS AREA_TYPE,
                      ...
                      SELECT 1 AS AREA_TYPE,
                             ...
                             IC.LOCATION_ID AS TOTAL_LOCATIONS,
                    ...
                    SELECT MAX(Q1.AREA_TYPE)                                                  AS AREA_TYPE,
                           ...
                           MAX(Q1.LOCATION_ID) KEEP(DENSE_RANK FIRST ORDER BY Q1.PIECES DESC) AS BEST_LOC,
                           MAX(Q1.PIECES) KEEP(DENSE_RANK FIRST ORDER BY Q1.PIECES DESC)      AS PCS_AT_BEST_LOC,
